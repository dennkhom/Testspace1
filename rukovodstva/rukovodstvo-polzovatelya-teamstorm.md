...
При вставке таблицы в описание отобразятся дополнительные инструменты форматирования таблицы:
...
6. Нажмите <img src="../.gitbook/assets/изображение (40) (1).png" alt="" data-size="line">
